                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      maxLines: 100,
                      decoration: InputDecoration(
                        hintText: 'you will se the resault here.',
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12)),
                      ),
                    ),
...
class _HomeState extends State<Home> {
  ...
  final searchController = TextEditingController();
  final replaceController = TextEditingController();
  final resultController = TextEditingController(); // اضافه شده
  ...
  void dispose() {
    ...
    searchController.dispose();
    replaceController.dispose();
    resultController.dispose(); // اضافه شده
    super.dispose();
  }
  ...
  void _pax() {
    ...
    Future.delayed(const Duration(milliseconds: 400), () {
      setState(() {
        resultController.text = newText; // اضافه شده
      });
    });
  }
  ...
  void _dePax() {
    setState(() {
      ...
      searchController.text = previousSearch;
      replaceController.text = previousReplace;
      resultController.text = previousText; // اضافه شده
      previousText = '';
      previousSearch = '';
      previousReplace = '';
    });
  ...
  void _reset() {
    setState(() {
      ...
      searchController.clear();
      replaceController.clear();
      resultController.clear(); // اضافه شده
      previousText = '';
      previousSearch = '';
      previousReplace = '';
    });
